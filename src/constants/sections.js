...
export const SectionTemplate = [
	...
	},
	{
		...
		boxKeys: [
			<Grid container key="eat-like-child">
				<h6>Eat Like a Child</h6>
				<p>
			...
			<Grid container key="home-cook">
				<h6>The Rise of the Home Cook: Arielle Faria</h6>
				<p>
			...
			<Grid container key="tea-sami">
				<Grid>
					<h6>Tea with Sami: Revenge Served HOT!</h6>
				</Grid>
