	...
	return (
		<>
			...
			>
				<div className="featured-atmosphere" aria-hidden="true">
					<svg
						...
						className="featured-atmosphere-svg"
					>
						<defs>
							<filter id="featured-noise">
								...
								<feComponentTransfer>
									<feFuncA type="table" tableValues="0 0 0.035" />
								</feComponentTransfer>
							</filter>
						</defs>
						<rect
							width="1440"
							height="980"
							filter="url(#featured-noise)"
							opacity="0.35"
						/>
						<path d="M-20 40 L410 40" className="featured-draft-line" />
						<path
							d="M138 100 C220 70, 290 145, 392 110"
							className="featured-draft-line featured-draft-line-soft"
						/>
						<path d="M980 120 L1390 20" className="featured-draft-line" />
						<path
							d="M1040 740 C1180 690, 1260 770, 1440 710"
							className="featured-draft-line featured-draft-line-soft"
						/>
					</svg>
					...
					<div className="featured-copy">
						...
						<h2 className="featured-heading">
							...
							<span className="featured-heading-line featured-heading-line-emphasis">
								into{" "}
								<span className="featured-clarity">
									clarity.
									<svg
										className="featured-clarity-stroke"
										viewBox="0 0 340 26"
									...
									>
										...
										<path
											d="M 8 16 C 60 6, 130 22, 200 12 C 260 6, 305 18, 332 10"
											stroke="#b8c87a"
											strokeWidth="9"
											fill="none"
											strokeLinecap="round"
											filter="url(#featured-rough)"
											opacity="0.55"
										/>
										<path
											d="M 10 18 C 70 10, 140 24, 205 14 C 265 8, 308 20, 330 12"
											stroke="#b8c87a"
											strokeWidth="5"
											fill="none"
											strokeLinecap="round"
										...
										/>
										<path
											d="M 12 20 C 80 14, 150 26, 200 16"
											stroke="#cad88e"
											strokeWidth="2.5"
											fill="none"
											strokeLinecap="round"
						...
						<button type="button" className="featured-scroll-cta">
							...
							<span aria-hidden="true" className="featured-scroll-cta-arrow">
								↓
							</span>
						</button>
					</div>

					<div className="featured-diagram" aria-hidden="true" ref={diagramRef}>
						<svg
					...
					<aside className="featured-panel" aria-label="What this page covers">
						...
						<div className="featured-focus-grid">
							{focusAreas.map((area, index) => (
								<article
									key={area.name}
									className={`featured-focus-card featured-focus-card-${index + 1}`}
								>
									<span className="featured-focus-mark" aria-hidden="true" />
									<area.Icon />
									<div>
										<h3>{area.name}</h3>
			...
			<div className="featured-ribbon" aria-hidden="true">
				<span className="featured-ribbon-prefix">I build</span>
				<div className="featured-ribbon-track-wrap">
					<div className="featured-ribbon-track" ref={trackRef}>
						{[...ribbonPhrases, ...ribbonPhrases].map((phrase, i) => (
							<span
								// eslint-disable-next-line react/no-array-index-key
								key={i}
								className="featured-ribbon-item"
							>
								{phrase}
							</span>
						))}
