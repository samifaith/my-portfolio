		...
		<div style={{ minHeight: "100vh", background: C.warm }}>
			...
			>
				...
				<section style={{ textAlign: "center", marginBottom: "2rem" }}>
					...
					>
						A travel app concept that replaces overwhelming search with a simple
						swipe-based experience — matching users to trips tailored to their
						style and budget.
					</p>
				...
				<Section number="02" title="Process">
					...
					>
						{[
							[
								"Research",
								"User interviews, surveys, competitive audit of Airbnb, TripAdvisor & Kayak",
							],
							[
								"Synthesize",
								"Affinity mapping, two personas, journey map highlighting key frustrations",
							],
							[
								"Ideate",
								"Sketches, lo-fi wireframes, swipe-based interaction model",
							],
							[
								"Test & Iterate",
								"3 rounds of usability testing with 24 participants via Maze",
							],
						].map(([title, desc], i) => (
							<div
								key={title}
				...
				<Section number="05" title="Results & Takeaways">
					...
					<div style={{ ...card, marginTop: "2rem" }}>
						...
						>
							<li>
								Constraint breeds clarity — limiting choices reduced decision
								fatigue.
							</li>
							<li>
								Testing early with paper prototypes saved two weeks of rework.
							</li>
							<li>
								Budget visibility was the #1 post-test feature request even
								before we built it.
							</li>
						</ul>
					</div>
